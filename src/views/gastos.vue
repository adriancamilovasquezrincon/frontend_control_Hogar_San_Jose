...
export default {
      ...
      headers: [
        {
          ...
          align: "start",
          sortable: false,
          value: "tipoGasto.nombreGasto",
        },
        { text: "Persona", value: "persona.tipoPersona" },
        { text: "ValorGasto", value: "valorGasto" },
  ...
  methods: {
      ...
      if (this.zb == 0) {
        ...
        axios
          .post(
            "gasto/guardar",
            {
              tipoGasto: this.editedItem.tipoGasto,
    ...
    editarItem(item) {
      ...
      console.log(item);
      this.id = item._id;
      this.editedItem.tipoGasto = item.tipoGasto;
    ...
    activar() {
      ...
      let header = { headers: { token: this.$store.state.token } };
      axios
        .put(`gasto/activar/${me.Id}`, {}, header)
        .then(function () {
          me.Modal = 0;
          me.Accion = 0;
          me.Nombre = "";
    ...
    desactivar() {
      ...
      let header = { headers: { token: this.$store.state.token } };
      axios
        .put(`gasto/desactivar/${me.Id}`, {}, header)
        .then(function () {
          me.Modal = 0;
          me.Accion = 0;
          me.Nombre = "";
    ...
    imprimir() {
      var columns = [
        { title: "TipoGasto", dataKey: "tipoGasto" },
