                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field
                            v-model="editedItem.nombreIngreso"
...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        { text: "nombreIngreso", value: "nombreIngreso" },
        { text: "valorIngreso", value: "valorIngreso" },
  ...
  methods: {
        ...
        axios
          .post(
            "ingreso/guardar",
            {
              ...
              nombreIngreso: this.editedItem.nombreIngreso,
    ...
    editarItem(item) {
      ...
      this.editedItem.nombreIngreso = item.nombreIngreso;
    ...
    activar() {
      ...
      let header = { headers: { token: this.$store.state.token } };
      axios
        .put(`ingreso/activar/${me.Id}`, {}, header)
        .then(function () {
          me.Modal = 0;
          me.Accion = 0;
          me.Nombre = "";
    ...
    desactivar() {
      ...
      let header = { headers: { token: this.$store.state.token } };
      axios
        .put(`ingreso/desactivar/${me.Id}`, {}, header)
        .then(function () {
          me.Modal = 0;
          me.Accion = 0;
          me.Nombre = "";
    ...
    imprimir() {
      var columns = [
        ...
        { title: "nombreIngreso", dataKey: "nombreIngreso" },
